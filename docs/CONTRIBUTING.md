...
This outlines how to propose a change to rsimsum. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ellessenne/rsimsum", fork = TRUE)`.
...
Please note that the rsimsum project is released with a [Contributor
Code of
Conduct](https://ellessenne.github.io/rsimsum/CODE_OF_CONDUCT.md). By
