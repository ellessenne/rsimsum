# {rsimsum}: Analysis of Simulation Studies Including Monte Carlo Error ![Hex logo of the {rsimsum} R package.](reference/figures/hex.png)
...
data (type
[`help("MIsim", package = "rsimsum")`](https://ellessenne.github.io/rsimsum/reference/MIsim.md)
...
![](reference/figures/README-lolly-1.png)
...
![](reference/figures/README-zipper-1.png)
...
![](reference/figures/README-ba-1.png)
...
![](reference/figures/README-nlp-1.png)
...
![](reference/figures/README-hex-1.png)
...
and
[`?rsimsum::autoplot.simsum`](https://ellessenne.github.io/rsimsum/reference/autoplot.simsum.md)
for further details.
