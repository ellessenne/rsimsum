...
#'
#' The function \code{nsim} computes the number of simulations \eqn{B}{B} to perform based on the accuracy of an estimate of interest, using the following equation:
...
#' @export
#'
#' @references Burton, A., Douglas G. Altman, P. Royston. et al. 2006. The design of simulation studies in medical statistics. Statistics in Medicine 25: 4279-4292 \url{http://dx.doi.org/10.1002/sim.2673}
#'
#' @examples
