...
It is also possible to _zoom_ on the top x% of the zip plot to increase readibility, e.g. on the top 30%:
...
Nested loop plots aim to have all simulation results in one plot by bringing all scenarios into a lexicographical order and arranging them consecutively on the horizontal axis of a plot, with the performance measure estimate on the vertical axis:
