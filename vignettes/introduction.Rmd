...
More information on producing tables directly from R can be found in the [CRAN Task View on Reproducible Research](https://cran.r-project.org/web/views/ReproducibleResearch.html).
