...
According to the documentation of the `ggridges` package ([source](https://cran.r-project.org/web/packages/ggridges/vignettes/introduction.html)),
...
It is recommended to use a different colour palette with better characteristics, e.g. the viridis colour palette from `matplotlib`; see the next section for details on how to do this, and [here](https://cran.r-project.org/web/packages/viridis/vignettes/intro-to-viridis.html) for details on the viridis colour palette.
