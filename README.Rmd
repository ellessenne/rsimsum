...
If you use RStudio and equations are not displayed properly within the RStudio viewer window, please access the vignette from [the CRAN website](https://CRAN.R-project.org/package=rsimsum) or directly from the R console with the command:
