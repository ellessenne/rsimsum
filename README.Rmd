...
<!-- badges: start -->
[![R build status](https://github.com/ellessenne/rsimsum/workflows/R-CMD-check/badge.svg)](https://github.com/ellessenne/rsimsum/actions)
[![Codecov test coverage](https://codecov.io/gh/ellessenne/rsimsum/branch/master/graph/badge.svg)](https://codecov.io/gh/ellessenne/rsimsum?branch=master)
...
[![JOSS DOI](http://joss.theoj.org/papers/10.21105/joss.00739/status.svg)](https://doi.org/10.21105/joss.00739)
...
* White, I.R. 2010. _simsum: Analyses of simulation studies including Monte Carlo error_. The Stata Journal 10(3): 369-385 <[https://www.stata-journal.com/article.html?article=st0200](https://www.stata-journal.com/article.html?article=st0200)>
...
If you use RStudio and equations are not displayed properly within the RStudio viewer window, please access the vignette from the [CRAN website](https://CRAN.R-project.org/package=rsimsum), the [rsimsum website](https://ellessenne.github.io/rsimsum/), or directly from the R console with the command:
